          ...
          <MDBContainer fluid className="my-5">
            <MDBRow>
              ...
              <MDBCol md="12" lg="4" className="mb-4 mb-lg-0">
                <MDBCard className="glassmorphism-card">
                  ...
                  <MDBCardImage src="assets/hangit.jpg" position="top" alt="Hangman" className="img1" />
                  <MDBCardBody>
              ...
              <MDBCol md="12" lg="4" className="mb-4 mb-lg-0">
                <MDBCard className="glassmorphism-card">
                  ...
                  <MDBCardImage src="assets/snake.jpg" position="top" alt="Snake Game" className="img1" />
                  <MDBCardBody>
                    <div className="d-flex justify-content-between mb-3">
              ...
              <MDBCol md="12" lg="4" className="mb-4 mb-lg-0">
                <MDBCard className="glassmorphism-card">
                  ...
                  <MDBCardImage src="https://tse4.mm.bing.net/th?id=OIP.0umEsI5We9_Ipqy5akmifwHaEb&pid=Api&P=0&h=180" position="top" alt="Space Game" className="img1" />
                  <MDBCardBody>
                    <div className="d-flex justify-content-between mb-3">
